        ...
        <div class="container-post">
            ...
            <form action="create-post.php" method="post">
                <div class="group-input">
                    <input type="text" name="titulo_vaga" id="titulo_vaga" placeholder="Título da vaga" required title="Este campo não pode estar vazio!">
                </div>
                <div class="group-input">
                    <label for="area_vaga">Área</label>
                    <select name="area_vaga" id="area_vaga" required title="Este campo não pode estar vazio!">>
                ...
                <div class="group-input">
                    ...
                    <select name="localizacao" id="localizacao" required title="Este campo não pode estar vazio!">>
                        ...
                        <option selected="selected" value="Luanda">Luanda</option>
                ...
                <div class="group-input">
                    ...
                    <textarea name="descricao_vaga" id="descricao_vaga" cols="30" rows="20" placeholder="Descreva a vaga, quais competências procura, o perfil ideal..." required></textarea>
                </div>
                <div class="group-input btn-row">
                    <button type="submit" name="submit" class="btn-post"><i class="fa-solid fa-circle-plus"></i> Criar</button>
                    <a  href="manage-post.php" class="btn-post"><i class="fa-solid fa-xmark"></i> Cancelar</a>
                </div>
            </form>
        </div>
    </main>
